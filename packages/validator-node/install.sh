...
echo "    pnpm --filter @talken/validator-node exec tsx src/index.ts request-unstake"
echo "    pnpm --filter @talken/validator-node exec tsx src/index.ts claim-unstake"
echo ""
